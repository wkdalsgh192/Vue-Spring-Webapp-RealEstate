<template>
    <div>
        <div id="seg">
            <span style="display:none;">{{updateKeyword}}</span>
            <div class="item-cell" v-for="(result, index) in results" :key="result.no">
                ...
                <div class="item-cell-desc">
                    ...
                    <div class="item-main">
                        ...
                        <div class="item-desc-btns">
                            <modal-component modalTitle="실거래가" :aptName="result.aptName"></modal-component>
                            <modal-component modalTitle="주변정보" :aptName="result.aptName"></modal-component>
                        </div>
                    </div>
        ...
        <div class="map" id="map" style="width: 100%; height: 1200px; margin: auto;">
            <v-toolbar
            dense
            floating
            style="z-index: 10;"
...
<style>
    ...
    .item-cell-desc .item-main {
        display:flex;
    }

    .item-cell-desc .item-price-area {
        width: 10rem;
    }

    .item-cell-desc .item-desc-btns {
        width: 5rem;
    }
