...
<body id="page-top">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto" id="navbarManuList">
					...
					<c:if test="${member ne null}">
						<li class="nav-item"><a class="nav-link js-scroll-trigger"
							href="${root}/member.do/board">공지사항</a></li>
						<li class="nav-item"><a class="nav-link js-scroll-trigger"
							href="#">오늘의 뉴스</a></li>
						<li class="nav-item"><a class="nav-link js-scroll-trigger"
	...
	<main>
		<div class="container main">
			<section class="content">
				<div class="results">
					<ul class="nav">
						<li class="nav-item"><a class="nav-link" href="#"><h3>아파트별</h3></a>
						</li>
						<li class="nav-item"><a class="nav-link" href="#">거래 정보</a></li>
						<li class="nav-item"><a class="nav-link disabled" href="#">관심
								목록</a></li>
					</ul>
					<div class="separator"></div>
					<div class="items-list">
						<ul class="nav">
							<li class="item-block"><c:forEach var="apartment"
									items="${list}">
									<div class="item-cell">
										<div class="item-cell-img">
											<img src="${root}/img/dogok-raemian.jpg">
										</div>
										<div class="item-cell-desc">
											<h4>
												<a class="item-title" href="javascript:void(0);">${apartment.aptName}</a>
											</h4>
											<p>거래금액 : ${apartment.dealAmount } 천 원</p>
											<p>
												면적 : <span> ${apartment.area } </span>
											</p>
											<p>
												최종 수정일 : <span>2020.10.16</span>
											</p>
										</div>
									</div>
								</c:forEach></li>
			...
			<section class="content">
				<div class="card col-sm-12 mt-1" style="max-height: 400px;">
					...
					<div class="map" id="map"
						style="width: 100%; height: 500px; margin: auto;"></div>
	...
	<script defer
		src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD5ago2JSBMKaGQBBssDj6oCIPEsKGVY6o&callback=initMap&libraries=&v=weekly"></script>
	<!-- Core theme JS-->
